...
- ### Les machines stationnaires
  ...
  - La mortaiseuse
  - La calibreuse
  - Le centre d'usinage numérique (CNC)

- ### Le profilage (les moulures)

  - Les moulures contre profilables
  - Les moulures les plus courantes
...
- Les différents types de représentation (Croquis, Schéma,Esquisse, Dossier d’architecte, Dessin d’ensemble,Dessin de définition, Perspective, Perspective éclatée)
- Les différents types de plans (Plan de masse, Plan de situation, Plan de coupe, Plan de détail, Plan d’exécution, Plan de fabrication)
- Les différents types de projections (Projection orthogonale, Projection isométrique, Projection cavalière, Projection axonométrique)
- Les différents types de vues
  - Vues de face, Vues de dessus, Vues de côté,
  - Vues éclatées
  - Vues en coupe
  - Vues en élévation
  - Vues en perspective
- La cotation de fabrication
  - Surface référentielle de cotation
